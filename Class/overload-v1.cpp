/*
 ...
 Also note there is a bug in this version: the Animal pointers 
 is not calling proper overloaded method define in Cat.

 The fix is provided in overload-v2.cpp
